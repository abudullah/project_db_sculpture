...
def start_with_hash_password(em,pw,firstname,country,foldername,filename):
     
     try:
      sqlcmd="INSERT INTO usertable (email,password,firstname,country,foldername,filepath) VALUES (%s,%s,%s,%s,%s,%s)"
      
      
      pw=usefulhasing.p_hash(pw)
      variable=(em,pw,firstname,country,foldername,filename)
